...
<body id="page-top">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Cotizaciones realizadas</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="total-cotizaciones">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Compras con envíos
                                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Envíos aprobados</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="total-envios"><span class="fa fa-spinner fa-spin"></span></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Cotizaciones
                                        </span>
                                        <span class="mr-2">
    ...
    <?= Scripts::footers(array("jquery","bootstrap","sb-admin-2","system-user", "charts-clientes")); ?> 
</body>
